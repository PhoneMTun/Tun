  ...
  return (
    <nav className="bg-blue-900 h-screen w-56 p-4 fixed top-0 left-0 z-10">
      ...
      <div className="space-y-6">
        ...
        <Link to="/home/sale" className={`block text-white py-2 px-4 rounded transition duration-300 ${location.pathname === '/products' ? 'bg-blue-600 text-yellow-300' : 'hover:bg-blue-600 hover:text-yellow-300'}`}>Sale</Link>
